                ...
                [...fileDetail]?.map((elem, i) => (
                    <div key={i}>
                        <div className="img-box">
                            {elem?.type == 'image/png' || elem?.type == 'image/jpeg' || elem?.type == 'image/jpg' ? <Image src={elem instanceof File ? URL.createObjectURL(elem) : elem} className="img-fluid" width={100} height={100} alt="image" /> :
