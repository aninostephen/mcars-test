...
import { YupObject, nameSchema, unit_release } from '@/Utils/Validation/ValidationSchemas'
        ...
        <div className='save-back-button'>
            <Formik
                ...
                validationSchema={YupObject({ 
                    //car_unit_id: unit_release,
                    new_owner_id: nameSchema,
                    payment_type: nameSchema,
                    price: nameSchema,
                    already_payment: nameSchema,
                    later_payment: nameSchema,
                    staggered_payment: nameSchema,
